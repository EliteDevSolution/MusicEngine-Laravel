<div id="page-nav">
    <div class="outer">
        <ul>
            ...
            <li><a href="{{ route('frontend.auth.user.artist.manager.subscriptions') }}" class="page-nav-link @if(Route::currentRouteName() == 'frontend.auth.user.artist.manager.subscriptions') active @endif" data-translate-text="SUBSCRIPTIONS">{{ __('web.SUBSCRIPTIONS') }}<div class="arrow"></div></a></li>
        </ul>
    </div>
</div>
